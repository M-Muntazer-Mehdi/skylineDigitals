            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@skylinedigitals.com" className="text-gray-700 hover:text-orange-600 transition-colors font-medium">
                    info@skylinedigitals.com
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+1234567890" className="text-gray-700 hover:text-orange-600 transition-colors font-medium">
                    +1 (234) 567-890
                  </a>
                </div>
              </li>
